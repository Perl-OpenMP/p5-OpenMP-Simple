...
#pragma omp parallel default(none) private(i,j) \
  shared(p,my_rank,U_Curr_Above,U_Curr_Below,WIDTH,my_start,my_end,next_ptr,current_ptr,num_threads)
{
...
#pragma omp parallel default(none) private(i,j) \
  shared(W,p,my_rank,U_Curr_Above,U_Curr_Below,WIDTH,my_start,my_end,next_ptr,current_ptr,num_threads)
{
